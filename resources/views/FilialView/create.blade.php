...
<div class="col-8 m-auto">
    ...
    @endif
    @if(isset($filial))
        <form name="formEdit" id="formEdit" method="post" action="{{ url("filial/editar/$filial->id") }}">
            @method('PUT')
        @else
        ...
        @csrf
            ...
            <input class="form-control cnpj" type="text" name="cnpj" id="cnpj" maxlent="18" placeholder="CNPJ" value="{{ $filial->cnpj??'' }}" required />
